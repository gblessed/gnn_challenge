...
python3 predict.py -ds CBR+MB --ckpt-path ckpt/Baseline_cbr_mb/best_08_10 --tr-path "gnnet-ch23-dataset-cbr-mb/extracted_08_10_cv/0/training" --te-path "path_to_test_data"
'''
import os
import sys
