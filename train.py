...
"""
#python3 /home/ec2-user/gnnet-ch23-dataset-cbr-mb/GNNetworkingChallenge-2023_RealNetworkDT/train.py -ds MB0
import os
...
def train_and_evaluate(
    ...
    """
    ckpt_path = "ckpt/Baseline_cbr_mb/best_08_10"
    # Reset tf state
    _reset_seeds()
...
if __name__ == "__main__":
    ...
    if args.ds == "CBR+MB":
        ...
        ds_path = "/home/ec2-user/gnnet-ch23-dataset-cbr-mb/extracted_15_10_cv"
        model = models.Baseline_cbr_mb
    else:
